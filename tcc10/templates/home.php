...
<body>
    ...
    <div class="container col-md-6">
        <?php
            ...
            $sql = "SELECT * FROM arthur_assis.livros ORDER BY idl DESC LIMIT 10";
        ...
        <div class="tabela-fundo">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th class="text-center" scope="col">Adicionados recentemente</th>
                    </tr>
                </thead>
                <tbody class="">
                    <?php
            ...
            <a href="../static/livros/listarLivro.php">Ver mais...</a>
        </div><!--tabela-fundo-->
        <?php } ?>  
    </div>
        ...
        <footer id="footer">
            <div class="sobre">
                <div class="container baseboard">
                    ...
                    <a class="logout" href="confirmaLogout.php">Sair <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
