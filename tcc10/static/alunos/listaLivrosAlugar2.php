...
<body>
    ...
    <div class="divstyle">
        ...
        <?php 
            include '../conexao.php';
            $quebrada=explode("|", $_GET['nbotao']);
            $noffset = ($quebrada[3]-1)*10;
            $sql = "SELECT * FROM arthur_assis.livros WHERE alugado='Não' ORDER BY nomel LIMIT 10 OFFSET $noffset";
            $result = pg_query($conn, $sql);
            $sql2 = "SELECT * FROM arthur_assis.livros WHERE alugado='Não' ORDER BY nomel";
        ...
        <div class="container col-md-4 d-flex justify-content-center">
            <form action="pesquisaLivrosAlugar.php" method="post">
                ...
                <input type="text" name="iddoaluno" id="" style="opacity: 0;" value="<?php echo $ida ?>" readonly>
            </form>
        </div>
            <div class="container">
                <div class="tabela-fundo">
                    ...
                    ?>
                        <tr>
                            ...
                            <?php $paraquebrar= $quebrada[0] . "|" . $exibir["idl"] . "|" . $exibir["nomel"];?>
                            <td><a title="Alugar Livro" style="margin-top: auto;" class="alugarL" href="confirmaAlugaLivro.php?tenhoquequebrar=<?php echo $paraquebrar ?>"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" style="color:gray; margin-top: auto;"fill="currentColor" class="bi bi-journal-arrow-up" viewBox="0 0 16 16">
                    ...
                    <nav aria-label="Page navigation example">
                        ...
                        <?php }elseif($quebrada[3]!=1){ ?>    
                            <?php $x=$quebrada[3]-1; $quebrardnv=$paraquebrar . "|" . $x; ?>
                            <li class="page-item "><a class="page-link" href="listaLivrosAlugar2.php?nbotao=<?php echo $quebrardnv?>">Anterior</a></li>
                        <?php } for($i=1;$i<=$numbotoes;$i++) {?>
                            <li class="page-item"><a class="page-link" href="listaLivrosAlugar2.php?nbotao=<?php echo $paraquebrar . "|" . $i ?>"><?php echo $i ?></a></li>
                        <?php } if($quebrada[3]!=$numbotoes){ ?>
                            <?php $x=$quebrada[3]+1; $quebrardnv=$paraquebrar . "|" . $x; ?>
                            <li class="page-item"><a class="page-link" href="listaLivrosAlugar2.php?nbotao=<?php echo $quebrardnv ?>">Próximo</a></li>
                        <?php } elseif($quebrada[3]==$numbotoes){ ?>
