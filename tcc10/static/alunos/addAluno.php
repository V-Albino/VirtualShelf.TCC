                ...
                <form action="insertAluno.php" method="post" style="margin-top:2rem">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input class="form-control" type="text" name="txtNome" placeholder="Nome" required autocomplete="off">
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input class="form-control" type="text" name="txtTelefone" placeholder="Telefone" maxlength="13" required>
                        </div>
                        <div class="col-md-6">
