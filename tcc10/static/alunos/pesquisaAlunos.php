...
<body>
    ...
    <div class="divstyle">
            ...
            $sql = "SELECT * FROM arthur_assis.alunos WHERE lower(nome) like lower('%$valor%') or lower(sobrenome) like lower('%$valor%') or lower(sala) like lower('%$valor%') or lower(livroalugado) like lower('%$valor%') or lower(telefone) like lower('%$valor%') or lower(email) like lower('%$valor%') ORDER BY nome";            $result = pg_query($conn, $sql);
            if ($result) {
        ?>
                        ...
                        ?>
                            ...
                            <?php if($exibir["diadevolucao"]=='null'){ ?> 
                                ...
                                <?php } elseif ($exibir["diadevolucaon"] - $txt3 >= 0){
                                    ...
                                    <td><?php echo 'Atrasado ' . $atrasop . ' dias'; ?></td>
                        <?php } ?>
