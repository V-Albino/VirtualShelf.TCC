...
<body>
    <div class="header">
        ...
        $sql = "SELECT * FROM arthur_assis.alunos ORDER BY nome LIMIT 10 OFFSET $noffset";
            ...
            <div class="tabela-fundo">
                ...
                <nav aria-label="Page navigation example">
                        ...
                        <?php }elseif($_GET['nbotao']!=1){ ?>    
                            <li class="page-item "><a class="page-link" href="listarAluno2.php?nbotao=<?php echo $_GET['nbotao']-1 ?>">Anterior</a></li>
                        ...
                        <?php } if($_GET['nbotao']!=$numbotoes){ ?>
                            <li class="page-item"><a class="page-link" href="listarAluno2.php?nbotao=<?php echo $_GET['nbotao']+1 ?>">Próximo</a></li>
