...
<body>
    ...
    <div class="divstyle">
        ...
        <?php 
            include '../conexao.php';
            $sql = "SELECT * FROM arthur_assis.livros WHERE alugado='Não' ORDER BY nomel LIMIT 10 OFFSET 0";
            ...
            <div class="container">
                <div class="tabela-fundo">
                    ...
                    <nav aria-label="Page navigation example">
                        ...
                        <?php } ?>
                            <li class="page-item"><a class="page-link" href="listaLivrosAlugar2.php?nbotao=<?php echo $paraquebrar . "|" . 2 ?>">Próximo</a></li>
                        </ul>
                    </nav>
