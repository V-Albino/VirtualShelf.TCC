...
<div class="header">
    ...
    <div class="divstyle">
        ...
        <?php 
            ...
            $sql = "SELECT * FROM arthur_assis.livros WHERE lower(nomel) like lower('%$valor%') or lower(editora) like lower('%$valor%') or lower(autor) like lower('%$valor%') or lower(genero) like lower('%$valor%') or lower(isbn) like lower('%$valor%') or ano = '$valor' or lower(alugado) like lower('%$valor%') ORDER BY nomel";            $result = pg_query($conn, $sql);
            if ($result) {
        ?>
